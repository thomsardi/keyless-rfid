...
typedef std::array<std::array<uint8_t, 6>, 4> mac_reference_list;
typedef std::array<std::array<uint8_t, 10>, 4> ktp_reference_list;

mac_reference_list macList = {
  {
    {0xde, 0x37, 0xf6, 0xfd, 0x2e, 0x6b}, //xiaomi poco m4 pro
    {0xf8, 0x5e, 0xa0, 0x0a, 0xd7, 0x9b},  //asus sundaya
    {0x7e, 0xa1, 0x0a, 0xb7, 0x07, 0x27},  //farhan android
    {0x80, 0x91, 0x33, 0x2e, 0x94, 0xb1}  //farhan laptop
  }
};
...
ktp_reference_list ktpList = {
  {
    ...
    {0x05, 0x8b, 0x3e, 0xe3, 0xba, 0xd1, 0x00, 0x00, 0x00, 0x00}, //farhan e-ktp
    {0x02, 0x3a, 0x8e, 0x73, 0x85, 0xe0, 0x00, 0x00, 0x00, 0x00}, //pengguna sim c
  }
};
